...
public class ColorBlobDetectionActivity extends Activity  {
    ...
    Mat h=new Mat(70, 70, CvType.CV_8UC4);
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    Bitmap bMap=BitmapFactory.decodeResource(getResources(),R.drawable.ntitled);
    ...
    public void jules(){mDetector = new ColorBlobDetector();
        ...
        Log.i(TAG, "OpenCV loaded successfully4");


        Log.i(TAG, "OpenCV loaded successfully5");
        //Imgproc.cvtColor(h, h, Imgproc.COLOR_RGB2HSV_FULL);


        Core.putText(h, "=====TEST=====2013.09.15", new Point(100, 300), 3, 1, new Scalar(255, 0, 0, 255), 2);

        Imgproc.Canny(h, h, 300, 600, 5, true);
        Core.putText(h, "=====TEST=====2013.09.15", new Point(100, 300), 3, 1, new Scalar(255, 255, 255, 255), 2);
        process_ntitled();

        Log.i(TAG, "OpenCV loaded successfully6");
        bmap1=Bitmap.createBitmap(h.cols(),h.rows(), Bitmap.Config.ARGB_8888);
        Utils.matToBitmap(h,bmap1);
